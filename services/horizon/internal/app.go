...
func (a *App) init() {
	...
	// web.init
	a.web = mustInitWeb(a.ctx, a.historyQ, a.coreQ, a.config.SSEUpdateFrequency, a.config.StaleThreshold, a.config.IngestFailedTransactions, a.config.ShouldPopulateHalCustomLinks, a.config.IsIndentedJSON)
